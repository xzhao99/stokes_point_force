...
public:
  ...
  // return the spacial coordinate of a particle
  Point particle_coordinate(dof_id_type particle_id) const;
  
  // return the spacial coordiantes of all particles
  std::vector<Point> particle_coordinates() const;
  
  // return the radius of a particle
  Real particle_radius(dof_id_type particle_id) const;
  
  // return the radii of all particles
  std::vector<Real> particle_radii() const;
...
/// ============================================================================= ///
std::vector<Point> PolymerChain::particle_coordinates() const
{
  return _bead_coordinates;
}


/// ============================================================================= ///
Real PolymerChain::particle_radius(dof_id_type particle_id) const
{
  return _radius[particle_id];
}

/// ============================================================================= ///
std::vector<Real> PolymerChain::particle_radii() const
{
  return _radius;
}
...
void PolymerChain::init()
{
  ...
  // initialize the particle position and radius
  _bead_coordinates.resize(_num_beads);
  _radius.resize(_num_beads);
  Point pt0, pt1;
  pt0(0) = 0.0; pt0(1) = 0.0;
...
//  _spring_direction[0] = pt_n/pt_n_norm;
  ...
  const Real f0 = 1.0;            // point force magnitude
  _bead_force.resize(_num_beads);
  _bead_force[0] = f0*pt_n;
