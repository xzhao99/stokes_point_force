...
public:
   ...
   */
  explicit
  SingularExactSolution (const EquationSystems& es);

  /**
   * Destructor.
   */
  ~SingularExactSolution();
  ...
  /// ==============================================================================
  // attach the singular points and their influence radius,
  // the region inside the radius will be ignored during error estimation.
  void attach_singular_points(const std::vector<Point>& points,
                              const std::vector<Real>& radius)
  {
    _singular_points = points;
    _radius = radius;
    _points_attached = true;
  }
...
private:
  ...
  /// ============================= new private memebers ==========================
  // store the coordiantes of \p singular points
  std::vector<Point> _singular_points;
  
  // store the radii of singular points
  std::vector<Real> _radius;
  
  // flag to indicate if the singular points are attached
  bool _points_attached;
};
...
/// ==============================================================================
/// ==============================================================================
#include "singular_exact_solution.cxx"
